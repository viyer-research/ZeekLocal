...
def connect(name: str, url: str | None = None) -> TestClient:
    """
...
def build_event_arg_v1(arg: str | int | TaggedArg):
    """
...
def build_event_v1(topic: str, event_name: str, args: list[Any] | None = None) -> dict:
    """
    Build an event for testing using the qurky v1 format.

    Arguments can be whatevr is supported by build_event_arg_v1(.
    """
    if args is None:
        args = []
